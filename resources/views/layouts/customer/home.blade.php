...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="{{asset('templatesAdminLTE/index3.html') }}" class="navbar-brand">
                    <img src="{{asset('templatesAdminLTE/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    <!-- Left navbar links -->
                    <ul class="navbar-nav">
                      @include('layouts.customer.navbar.navbar-left') 
                    </ul>
                ...
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    @include('layouts.customer.navbar.navbar-right')
                </ul>
            </div>
        </nav>
        <!-- /.navbar -->
    ...
    <!-- AdminLTE App -->
    <script src="{{asset('templatesAdminLTE/dist/js/adminlte.min.js') }}"></script>
