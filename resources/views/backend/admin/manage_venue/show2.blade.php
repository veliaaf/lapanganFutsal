                                ...
                                <div class="ticket-content">
                                    <div class="ticket-header">
                                        ...
                                        @if ($venues->owner->avatar == NULL)
                                                    <img style="width:30px; height:30px" src="{{ asset('templates/img/avatar/avatar-5.png') }}" alt="image">
                                                @else
                                                    <img style="width:30px; height:30px"    src="{{ asset('images/owner/'.$venues->owner->avatar) }}" alt="image">
                                                @endif
                                        </div>
